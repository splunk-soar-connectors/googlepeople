...
INVALID_NON_ZERO_NON_NEGATIVE_INTEGER_ERROR_MESSAGE = "Please provide a valid non-zero positive integer value in the {}"
INVALID_COMMA_SEPARATED_ERROR_MESSAGE = "Please provide valid comma-seprated value in the '{}' action parameter"

LIMIT_KEY = "'limit' action parameter"

GOOGLE_CREATE_CLIENT_FAILED_MESSAGE = "Failed to create the Google People client"
GOOGLE_LIST_OTHER_CONTACTS_FAILED_MESSAGE = "Failed to list other contacts"
GOOGLE_LIST_PEOPLE_FAILED_MESSAGE = "Failed to list people"
GOOGLE_LIST_DIRECTORY_FAILED_MESSAGE = "Failed to list directory"
GOOGLE_COPY_CONTACT_FAILED_MESSAGE = "Failed to copy contact"
GOOGLE_GET_USER_PROFILE_FAILED_MESSAGE = "Failed to get user profile"
